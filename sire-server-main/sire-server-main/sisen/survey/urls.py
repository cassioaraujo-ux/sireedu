...
urlpatterns = [
    ...
    # Endpoint global para todas as turmas (USADO PELO REVISOR)
    path(r'classes', sclass.all_classes, name='all_classes'),
    ...
    # NEW ROUTES TO FIX BUGS AND ENABLE WORKFLOW
    path(r'educational-types', recommendation.get_educational_types, name='get_educational_types'),
    path(r'product/suggest', recommendation.suggest_product, name='suggest_product'),
    
    # ADMIN / REVISOR ROUTES
    path(r'admin/pending-products', admin.get_pending_products, name='get_pending_products'),
    path(r'admin/product/<int:product_id>/review', admin.review_product, name='review_product'),
